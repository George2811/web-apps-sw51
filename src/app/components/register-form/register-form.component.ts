...
export class RegisterFormComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, public dialog: MatDialog, private router: Router, private artistProfileService: ArtistProfileService) {
  ...
  sendUserToNextPage() {
    if (this.registerForm.controls['userType'].value == 1) {
      ...
      this.artistProfileService.setArtist(true);
    }
    else {
      this.router.navigate(['/home']);
      this.artistProfileService.setArtist(false);
    }
  }
}
